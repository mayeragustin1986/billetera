...
Luego ejecutar `supabase/migrations/202607280004_financial_spaces_accounts.sql` para crear espacios financieros y cuentas, migrar los registros existentes y actualizar RLS.
