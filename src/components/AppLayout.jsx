import { Clock3, House, LogOut, Shapes, Wallet } from "lucide-react";
...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#08090a] pb-28 text-[#f5f5f7] md:pb-0">
      ...
      <nav className="fixed inset-x-3 bottom-3 z-40 grid grid-cols-3 rounded-[1.7rem] border border-white/10 bg-[#1c1c1e]/95 p-2 shadow-2xl backdrop-blur-xl md:hidden">
        {nav.map(({ to, label, icon: Icon, end }) => (
